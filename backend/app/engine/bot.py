...
class TradingEngine:
    ...
    def _sample_interval(self, market: dict, asset: str, stc: float) -> None:
        ...
        rec = {
            ...
            "twap": round(twap, 4) if twap is not None else None,
            "twap_age": twap_age,
            "twap_open": round(twap_open, 4) if twap_open is not None else None,
    ...
    def _log_resolution(self, pos: Position, won: Optional[bool], pnl: float,
        ...
        rec = {
            ...
            "cross_agree": agree,
            "twap_open": round(twap_open, 4) if twap_open is not None else None,
            "twap_close": round(twap_close, 4) if twap_close is not None else None,
